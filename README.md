<div align="center">
  <h1>😡 RageRoom</h1>
  <p><strong>The AI De-escalation Simulator</strong></p>
  <p><em>“Build Something That Couldn't Have Existed Two Years Ago”</em></p>
  
  ![Hackathon Track](https://img.shields.io/badge/Track-Agents_%26_Automation-blue?style=for-the-badge)
  ![Stack](https://img.shields.io/badge/Stack-MERN_%2B_LLMs-success?style=for-the-badge)
</div>
...
## 🙋‍♂️ 1. The Five Questions ("Why Shortlist Us?")
...
### ⚙️ What did you build versus what did the API give you?
**The API gave us:** Raw text generation.  
**We built:**
- 🌡️ A **Dynamic Emotional State Engine** (Frustration, Patience, Trust, Loyalty) that fluctuates in real-time.
- 🎙️ An **Auto-submitting Voice-Activity Detection (VAD)** loop using the Web Speech API that simulates an uninterrupted phone call.
...
- ☎️ **Automated Hang-ups:** Logic that forcefully cuts the user off and fails the session if the customer's patience threshold is breached.
...
## ⚠️ 4. Failure Log (Engineering Maturity)
